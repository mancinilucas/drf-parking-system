...
class Commercial_Establishment(models.Model):
    ...
    car_parking_spaces = models.IntegerField(blank=False)
    motorcycle_parking_spaces = models.IntegerField(blank=False)
...
class Vehicle(models.Model):
    ...
    car_plate = models.CharField(max_length=7, blank=False, unique=True)
